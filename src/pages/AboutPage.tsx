    ...
    <div className="min-h-screen bg-dark-900 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-dark-800 rounded-lg p-8 space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-accent-pink mb-4">🎯 프로젝트 소개</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-pink mb-4">💻 기술 스택</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-pink mb-4">👥 기여 방법</h2>
            ...
            <a 
              ...
              className="inline-flex items-center space-x-2 bg-dark-700 hover:bg-dark-600 text-white px-4 py-2 rounded-lg transition-colors"
            >
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-pink mb-4">📧 Contact</h2>
            <p className="text-gray-300">
              문의사항은 ASC 디스코드 서버에서 @seory0로 연락주세요.
            </p>
          </section>
        </div>
      </div>
