...
export const config = {
  ...
  githubOAuth: {
    ...
    redirectUri: process.env.REACT_APP_REDIRECT_URI || 'https://WargameBandits.github.io/WargameBandits/callback',
  ...
  api: {
    baseUrl: process.env.REACT_APP_API_URL || 'https://your-vercel-app.vercel.app/api'
  },
